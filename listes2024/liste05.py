...
for i in range(1, len(ventes), 2) :
    ventes_moyen +=  ventes[i]
    nombre_de_villes += 1  

print(f"La moyenne des ventes est de : {round((ventes_moyen/nombre_de_villes), 2)}")  # Afficher la moyenne au fur et à mesure